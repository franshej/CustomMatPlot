...
namespace cmp {
	...
	PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::PlotLookAndFeelDefault() { setDefaultPlotColours(); }

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::setDefaultPlotColours() noexcept {
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::drawBackground(juce::Graphics& g,
		juce::Rectangle<int>& bounds) {};

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	juce::Colour PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::findAndGetColourFromId(
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Rectangle<int> PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getPlotBounds(
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	juce::Rectangle<int> PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getGraphBounds(const juce::Rectangle<int> bounds,
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 std::size_t PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getMaximumAllowedCharacterGridLabel()
		const noexcept {
		return 6u;
	};

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Point<int> PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getLegendPosition(
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Rectangle<int> PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getLegendBounds(
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Font PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getLegendFont() const noexcept {
		return juce::Font(14.0f, juce::Font::plain);
	}

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Font PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getButtonFont() const noexcept {
		return juce::Font(14.0f, juce::Font::plain);
	}

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 Plot::ColourIdsGraph PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getColourFromGraphID(
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 std::size_t PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getMargin() const noexcept { return 8u; }

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 std::size_t PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getMarkerLength() const noexcept {
		return 20u;
	}

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	std::pair<juce::Rectangle<int>, juce::Rectangle<int>> PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getTraceXYLabelBounds(
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Rectangle<int> PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getTraceLabelLocalBounds(
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Rectangle<int> PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getTracePointLocalBounds()
		const noexcept {
		return juce::Rectangle<int>(0, 0, 10, 10);
	}

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Font PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getTraceFont() const noexcept {
		return juce::Font(14.0f, juce::Font::plain);
	}

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Point<int> PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getTracePointPositionFrom(
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::drawGraphLine(juce::Graphics& g,
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::drawGridLabels(juce::Graphics& g, const LabelVector& x_axis_labels,
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::drawFrame(juce::Graphics& g,
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::drawGridLine(juce::Graphics& g, const GridLine& grid_line,
		const bool grid_on) {
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::drawLegend(juce::Graphics& g, const StringVector& label_texts,
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::drawTraceLabel(juce::Graphics& g, const cmp::Label& x_label,
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::drawTracePoint(juce::Graphics& g,
		const juce::Rectangle<int>& bounds) {
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::updateXGraphPointsAndIndices(
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::updateYGraphPoints(const juce::Rectangle<int>& bounds,
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::updateVerticalGridLineTicksAuto(
		const juce::Rectangle<int>& bounds, const bool tiny_grids,
		const Lim_f x_lim, std::vector<float>& x_ticks) noexcept {
		x_ticks.clear();
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::updateHorizontalGridLineTicksAuto(
		const juce::Rectangle<int>& bounds, const bool tiny_grids,
		const Lim_f y_lim, std::vector<float>& y_ticks) noexcept {
		y_ticks.clear();
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Font PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getGridLabelFont() const noexcept {
		return juce::Font("Arial Rounded MT", 16.f, juce::Font::plain);
	}

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 juce::Font PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getXYTitleFont() const noexcept {
		return juce::Font(20.0f, juce::Font::plain);
	}

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 Scaling PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getXScaling() const noexcept {
		return m_x_scaling;
	};

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	CONSTEXPR20 Scaling PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::getYScaling() const noexcept {
		return m_y_scaling;
	};

	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::updateGridLabels(const CommonPlotParameterView common_plot_params,
	...
	template <Scaling x_scaling_t, Scaling y_scaling_t>
	void PlotLookAndFeelDefault<x_scaling_t, y_scaling_t>::updateXYTitleLabels(const juce::Rectangle<int>& bounds,
		const juce::Rectangle<int>& graph_bounds,
	...
	template class PlotLookAndFeelDefault<Scaling::logarithmic, Scaling::logarithmic>;
}